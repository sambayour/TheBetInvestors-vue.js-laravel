                ...
                <div class="card">
                  <div class="card-body">
                    <div class="table-responsive">
                      <div class="text-center" v-if="Object.keys(daily2odds).length === 0">
                        <h3>
                      ...
                      <table v-else class="table mb-0">
                        ...
                        <tbody>
                          <tr v-for="daily in daily2odds" :key="daily.id">
                            <td>{{ daily.country }}</td>
                            <td>{{ daily.teams }}</td>
                            <td>{{ daily.tip }}</td>
                            <td>
                  ...
                  <div class="table-responsive">
                    <table class="table mb-0">
                      ...
                      <tbody>
                        ...
                        <tr
                          v-for="all in daily2oddsAll.slice(
                                                                    0,
                                                                    10
                                                                )"
                          :key="all.id"
...
export default {
  ...
  computed: {
    isEmpty: function () {
      return jQuery.isEmptyObject(this.loadDaily2odds);
    },
  },
};
</script>
