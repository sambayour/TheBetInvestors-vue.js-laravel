<template>
  <div class="container">
    ...
    <div
      ...
      style="background-image: url(images/header-hero.jpg);height: 600px;"
    >
      <div class="container">
        <div class="row">
          <div class="col-lg-4">
            <div class="image">
              <img
                ...
                alt="TheBetInvestors Banner Image"
              />
            </div>
          </div>
          <div class="col-lg-8">
            <div class="header-hero-content">
              ...
              >
                <b>Both team to score tips</b> on
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="table-responsive">
                      <div class="text-center" v-if="Object.keys(btts).length === 0">
                        <h3>
                          No Tips Added Yet For
                          Today
                        </h3>
                      </div>
                      <table v-else class="table mb-0">
                        ...
                        <tbody>
                          <tr v-for="bts in btts" :key="bts.id">
                            <td>{{ bts.country }}</td>
                            <td>{{ bts.teams }}</td>
                            <td>{{ bts.tip }}</td>
                            <td>
          ...
          <div class="col-lg-12">
            ...
            >
              <div v-if="ad.position == 'BOTTOM'">
                ...
                <a target="_blank" :href="ad.url">
                  <img id="adsMobile" style="height: 83px;"  :src="ad.image" alt="ADS-on-TheBetInvestors" />
                </a>
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {},
  isEmpty: function () {
    return jQuery.isEmptyObject(this.loadGG);
  },
};
</script>
