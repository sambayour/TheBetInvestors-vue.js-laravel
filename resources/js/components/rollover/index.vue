                ...
                <div class="card">
                  <div class="card-body">
                    <div class="table-responsive">
                      <div class="text-center" v-if="Object.keys(rollovers).length === 0">
                        <h3>
                      ...
                      <table v-else class="table mb-0">
                        ...
                        <tbody>
                          <tr
                            v-for="rollover in rollovers.slice(
                                                            0,
                                                            3
                                                        )"
                            :key="rollover.id"
                          >
                            <td>{{ rollover.country }}</td>
                            <td>{{ rollover.teams }}</td>
                            <td>{{ rollover.tip }}</td>
                            <td>
                              <span
                                v-if="
                  ...
                  <div class="table-responsive">
                    <table class="table mb-0">
                      ...
                      <tbody>
                        ...
                        <tr
                          v-for="all in rolloversAll.slice(
                                                                    0,
                                                                    10
                                                                )"
                          :key="all.id"
