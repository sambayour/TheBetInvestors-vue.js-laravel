                ...
                <div class="card">
                  <div class="card-body">
                    <div class="table-responsive">
                      <div class="text-center" v-if="Object.keys(razor5odds).length === 0">
                        <h3>
                      ...
                      <table v-else class="table mb-0">
                        ...
                        <tbody>
                          <tr v-for="daily in razor5odds" :key="daily.id">
                            <td>{{ daily.country }}</td>
                            <td>{{ daily.teams }}</td>
                            <td>{{ daily.tip }}</td>
                            <td>
                  ...
                  <div class="table-responsive">
                    <table class="table mb-0">
                      ...
                      <tbody>
                        ...
                        <tr
                          v-for="all in razor5oddsAll.slice(
                                                                    0,
                                                                    10
                                                                )"
                          :key="all.id"
...
export default {
  ...
  computed: {
    isEmpty: function () {
      return jQuery.isEmptyObject(this.loadToday5odds);
    },
  },
};
</script>
