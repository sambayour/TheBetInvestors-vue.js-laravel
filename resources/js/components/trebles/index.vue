                ...
                <div class="card">
                  <div class="card-body">
                    <div class="table-responsive">
                      <div class="text-center" v-if="Object.keys(trebles).length === 0">
                        <h3>
                      ...
                      <table v-else class="table mb-0">
                        ...
                        <tbody>
                          <tr v-for="daily in trebles" :key="daily.id">
                            <td>{{ daily.country }}</td>
                            <td>{{ daily.teams }}</td>
                            <td>{{ daily.tip }}</td>
                            <td>
...
export default {
  ...
  computed: {
    isEmpty: function () {
      return jQuery.isEmptyObject(this.loadTodayTrebles);
    },
  },
};
</script>
